    ...
    return (
        <div className="delay-40 group relative flex h-full w-full items-center justify-center rounded-xl from-portafino-100 to-portage-300 transition duration-300 hover:-translate-y-1 hover:bg-gradient-to-r">
            ...
            <div className="absolute left-[50%] top-[50%] hidden translate-x-[-50%] translate-y-[-50%] group-hover:block">
                ...
                <p className="pt-4 text-center text-2xl font-bold text-black drop-shadow-2xl">
                    {description}
                </p>
                <p className="pb-6 pt-4 text-center text-lg font-bold text-black drop-shadow-2xl">
                    {language}
                </p>
